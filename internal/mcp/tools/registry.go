...
// NewRegistryWithTools creates a registry with all backup tools registered.
func NewRegistryWithTools(toolCtx *ToolContext) *ToolRegistry {
	registry := NewToolRegistry()
	registerBackupToolsToRegistry(registry, toolCtx)
	return registry
}
